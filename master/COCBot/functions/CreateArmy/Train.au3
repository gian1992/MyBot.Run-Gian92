	...
	If $icmbTroopComp = 8 Then
		...
		While isBarrack()
			...
			Switch $barrackTroop[$brrNum - 1]
				Case 0
					TrainClick(220, 390 + $midOffsetY, 75, 10, $FullBarb, $GemBarb, "#0274") ; Barbarian
				Case 1
					TrainClick(331, 390 + $midOffsetY, 75, 10, $FullArch, $GemArch, "#0275") ; Archer
				Case 2
					TrainClick(432, 390 + $midOffsetY, 15, 10, $FullGiant, $GemGiant, "#0276") ; Giant
				Case 3
					TrainClick(546, 390 + $midOffsetY, 75, 10, $FullGobl, $GemGobl, "#0277") ; Goblin
				Case 4
					TrainClick(647, 390 + $midOffsetY, 37, 10, $FullWall, $GemWall, "#0278") ; Wall Breaker
				Case 5
					TrainClick(220, 500 + $midOffsetY, 15, 10, $FullBall, $GemBall, "#0279") ; Balloon
				Case 6
					TrainClick(331, 500 + $midOffsetY, 18, 10, $FullWiza, $GemWiza, "#0280") ; Wizard
				Case 7
					TrainClick(432, 500 + $midOffsetY, 5, 10, $FullHeal, $GemHeal, "#0281") ; Healer
				Case 8
					TrainClick(546, 500 + $midOffsetY, 3, 10, $FullDrag, $GemDrag, "#0282") ; Dragon
				Case 9
					TrainClick(647, 500 + $midOffsetY, 3, 10, $FullPekk, $GemPekk, "#0283") ; Pekka
			EndSwitch
